...
<template>
  <v-responsive>
    <v-app :theme="theme">
      <v-app-bar class="px-3" color="transparent" flat>
        <v-spacer></v-spacer>
        <v-btn :icon="theme === 'light' ? 'mdi-weather-sunny' : 'mdi-weather-night'" variant="text"
          @click="onClick"></v-btn>
      </v-app-bar>
            ...
            <v-col cols="12" md="8">
              ...
              <v-row dense>
                ...
                <v-col cols="12" sm="4" class="mb-4">
                  ...
                  <div class="d-flex align-center mb-1 text-caption">
                    <v-icon color="blue" size="18" class="me-2">mdi-gmail</v-icon> leanheitmayminoza@gmail.com
                  </div>
                  <div class="d-flex align-center text-caption">
